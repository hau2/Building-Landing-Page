      ...
      <footer className="bg-[#152E51] py-8 mt-20">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
          <div>
            ...
            <p className="text-gray-400 text-base mt-4">{t("vision")}</p>
          </div>

          <div>
            <div className="ml-0 md:ml-24">
              <h2 className="font-bold text-xl text-white mb-4">SITEMAP</h2>
          ...
          <div>
            <h2 className="font-bold text-xl text-white mb-4">CONTACT</h2>
