...
export default function DuAnNoiBat() {
    ...
    return (
        <div className="px-4 sm:px-8 md:px-20 w-full">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#152E51] ">
                ...
                >
                    {listDuAn?.map((item, index) => (
                        <SwiperSlide key={index} className="slide-custom">
                            <motion.div
                                className="relative w-full aspect-[4/5] max-h-[500px] group rounded-lg overflow-hidden"
                                ...
                                >
                                    <div className="p-1 flex items-center justify-center group relative w-full h-full">
                                        ...
                                        <Image
                                            ...
                                            alt={`Slide ${index + 1}`}
                                            fill
                                            className="object-cover rounded-lg transition-transform duration-500 group-hover:scale-105 group-hover:opacity-90"
                                        />
                                        <div className="absolute top-0 left-0 w-full h-full bg-black/10 rounded-lg pointer-events-none" />
                                        ...
                                        <motion.div
                                            ...
                                            className="absolute bottom-8 bg-black/20 shadow-2xl transition-all duration-300 px-3 py-2 rounded-lg"
                                        >
                                            <p className="text-white text-lg font-semibold uppercase text-center">
                                                {projectTranslate(
                                                    `${item.id}.name`
                                                )}
                                            </p>
                                        ...
                                        {/* Overlay thông tin chi tiết */}
                                        <motion.div
                                            initial={{ y: 30, opacity: 0 }}
                                            whileHover={{ y: 0, opacity: 1 }}
                                            transition={{ duration: 0.5 }}
                                            className="absolute inset-0 p-4 bg-black/50 text-white rounded-lg flex flex-col justify-start opacity-0 group-hover:opacity-100"
                                        >
