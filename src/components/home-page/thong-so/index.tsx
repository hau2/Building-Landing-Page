    ...
    return (
      <div className="pt-[32px] pb-[32px] flex flex-col items-center justify-center bg-white">
         <div className="text-center p-5">
          <div className="text-2xl font-bold text-blue-900">TỔNG THẦU XÂY DỰNG & MEPF HÀNG ĐẦU VIỆT NAM</div>
          ...
          <div className="flex flex-wrap justify-around mt-8">
            <div className="m-4 text-center">
              <div className="text-lg font-bold text-gray-700">DỰ ÁN THI CÔNG</div>
            ...
            <div className="m-4 text-center">
              <div className="text-lg font-bold text-gray-700">DOANH SỐ BACKLOG</div>
              <div className="text-4xl font-bold text-orange-600">
            ...
            <div className="m-4 text-center">
              <div className="text-lg font-bold text-gray-700">TỔNG SỐ NHÂN VIÊN</div>
              <div className="text-4xl font-bold text-orange-600">
            ...
            <div className="m-4 text-center">
              <div className="text-lg font-bold text-gray-700">LỰC LƯỢNG THI CÔNG</div>
              <div className="text-4xl font-bold text-orange-600">
