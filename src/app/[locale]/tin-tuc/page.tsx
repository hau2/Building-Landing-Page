    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="bg-white rounded-lg overflow-hidden">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold">Dự án Bệnh viện Đa khoa Hồng Ngọc - Phúc Trường Minh</h3>
        ...
        <div className="bg-white rounded-lg overflow-hidden">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold">Dự án Nhà máy Milwaukee TTI</h3>
        ...
        <div className="bg-white rounded-lg overflow-hidden">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold">Dự án Sanctuary Hồ Tràm</h3>
        ...
        <div className="bg-white rounded-lg overflow-hidden">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold">Dự án Sân bay Quốc tế Long Thành</h3>
        ...
        <div className="bg-white rounded-lg overflow-hidden">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold">Dự án Nhà máy Milwaukee</h3>
        ...
        <div className="bg-white rounded-lg overflow-hidden">
          ...
          <div className="p-4">
            <h3 className="text-xl font-semibold">Căn hộ hạng sang LUMIÈRE riverside của Masterise Homes</h3>
