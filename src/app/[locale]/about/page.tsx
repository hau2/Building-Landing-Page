                ...
                <div className="max-w-7xl mx-auto my-[16px] bg-white border-1 overflow-hidden flex flex-col sm:flex-row">
                    ...
                    <div className="flex-1 p-10 bg-white text-gray-800">
                        <div className="grid grid-cols-2 gap-x-1 gap-y-4">
                            ...
                            <div className="ml-1">
                                CÔNG TY CỔ PHẦN TƯ VẤN THIẾT KẾ XÂY DỰNG BÌNH
                                DOANH
                            </div>
                            ...
                            <div className="font-semibold">Vốn điều lệ</div>
                            <div className="ml-1">200.000.000.000 VND</div>

                            <div className="font-semibold">Trụ sở chính</div>
                            <div className="ml-1">
                                Tỉnh lộ 767, thôn Tây Lạc,Ấp Bùi Chu, xã Bắc
                                Sơn, huyện Trảng Bom, tỉnh Đồng Nai, Việt Nam
                            </div>
                ...
                <div className="max-w-7xl mx-auto my-12 flex flex-col-reverse md:flex-row items-center gap-8">
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <p className="text-gray-800 leading-relaxed mb-4">
                            Công ty cổ phần tư vấn thiết kế xây dựng Bình Doanh
                            được thành lập năm 2006, tự hào là đơn vị dẫn đầu
                            khu vực trong việc ứng dụng các giải pháp công nghệ
                            hiện đại vào lĩnh vực xây dựng, nhằm mang đến cho
                            khách hàng những công trình chất lượng cao, thân
                            thiện với môi trường và tiết kiệm chi phí.
                        </p>
                        <p className="text-gray-800 leading-relaxed mb-4">
                            Đội ngũ kỹ sư giàu kinh nghiệm của chúng tôi luôn nỗ
                            lực nghiên cứu và triển khai các công nghệ mới như
                            hệ thống mô phỏng dự án (BIM), giúp quản lý hiệu quả
                            toàn bộ quy trình từ giai đoạn thiết kế đến khi hoàn
                            thiện, giảm thiểu rủi ro và tối ưu thời gian. Đến
                            với Bình Doanh, quý khách sẽ được tư vấn về thủ tục
                            pháp lý, lựa chọn vật tư, giá cả xây dựng và sẽ được
                            miễn giảm phần trăm chi phí thiết kế nếu các chủ đầu
                            tư chọn công ty Bình Doanh chúng tôi là đơn vị nhà
                            thầu thi công.
                        </p>
                        <p className="text-gray-800 leading-relaxed">
                            BÌNH DOANH luôn dẫn đầu và khác biệt bởi sự uy tín,
                            chính trực trong cam kết và cung cách làm việc
                            chuyên nghiệp. Các dự án của chúng tôi luôn có tiến
                            độ thi công ưu việt, chất lượng và thẩm mỹ cao.
                        </p>
                    </div>
