        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-blue-100 via-white to-blue-200 py-20 px-4 md:px-12 lg:px-24">
          ...
          <div className="relative z-10 text-center mb-16">
            ...
            <p className="text-gray-600 mt-3 text-lg animate-fade-in delay-200">
              Cấu trúc tổ chức và đội ngũ nhân sự chuyên môn cao
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-10 relative z-10">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-10 flex flex-col items-center text-center hover:scale-[1.02] transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Bộ máy điều hành gồm các phòng ban chuyên môn, vận hành linh
                hoạt và hiệu quả trong mọi lĩnh vực thi công.
              </p>
            </div>
              ...
              <div className="space-y-6 text-sm text-blue-900">
                <div>
                  ...
                  <ul className="space-y-1">
                    <li>
                      Kiến trúc sư: <strong>10 người</strong>
                    </li>
                    <li>
                      Kỹ sư xây dựng: <strong>40 người</strong>
                    </li>
                    <li>
                      Kỹ sư cơ khí: <strong>15 người</strong>
                    </li>
                    <li>
                      Kỹ sư cầu đường: <strong>5 người</strong>
                    </li>
                    <li>
                      Kỹ sư điện công nghiệp: <strong>5 người</strong>
                    </li>
                    <li>
                      Kỹ sư điện, điện lạnh: <strong>5 người</strong>
                    </li>
                    <li>
                      Cử nhân kinh tế tài chính: <strong>15 người</strong>
                    </li>
                    <li>
                      Cử nhân trắc địa: <strong>15 người</strong>
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-1">
                    <li>
                      Thường xuyên: <strong>Hơn 800 người</strong>
                    </li>
                    <li>
                      Thời vụ: <strong>Hơn 1.200 người</strong>
                    </li>
                  </ul>
                </div>
              </div>
